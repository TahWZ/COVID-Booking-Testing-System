...
/**
 * Form which displays when QR scan was successful for on site booking to allow confirmation.
 * @author User
 */
public class scanBookingForm extends javax.swing.JFrame {

    private Booking currentBooking;
    
    /**
     * Form which will update Booking status of associated Booking
     */
    public scanBookingForm(Booking currentBooking) throws Exception {
        initComponents();
    ...
    private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButtonActionPerformed
        ...
        if (bookingAPI.patchBookings(jsonString, currentBooking.getID())){
            JOptionPane.showMessageDialog(this, "Patient has arrived for booking", "Booking confirmed",JOptionPane.INFORMATION_MESSAGE);
